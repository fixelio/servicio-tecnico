...
@section('content')
  <section>
    ...
    <div class="card card-body border-0 shadow mb-4">
      ...
      <div class="d-block">
        <a href="" class="btn btn-primary me-2" id="pagina-principal">
    ...
    <script>
      window.addEventListener('DOMContentLoaded', () => {
        const $link = document.querySelector('#pagina-principal')
        $link.href = `${document.location.origin}/servicio-tecnico/public/solicitudes`
      })
    </script>
  </section>
@stop